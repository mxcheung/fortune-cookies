...
export class LambdaCdkStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    const table = dynamodb.Table.fromTableName(  this, "fortunes",  "fortunes" );

    // lookup api gateway
    const api = apigateway.RestApi.fromRestApiAttributes(this, 'FortunesApi', 
       { restApiId: '7og7xceam7', rootResourceId: 'z3v4wdnx6i' } );


    const lambdaFunction = new lambda.Function(this, 'YourLambdaFunctionRR', {
    ...
    const helloResource = api.root.addResource('fortunes');
